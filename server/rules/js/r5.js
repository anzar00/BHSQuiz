...
scene
    ...
    .addScene('arden:Spell Bee<br><span>Rules</span><br>')
    .addScene((done) => {
    ...
    .addScene(' 1) There are a total of 12 words , 2 for each team.<br>')
    .addScene(' 2) A chit will be drawn by the Jury, deciding which team will face the next two questions.<br>')
.addScene('   3) For a correct response, 5 points will be added. While 2 will be deducted for an incorect response.<br>  ')
.addScene(' 4) The words can be passed and the team to buzz first will get a chance to answer.<br>')
    .addScene((done) => {
        setTimeout(() => {
