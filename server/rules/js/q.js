...
scene
    ...
    .addScene('arden:Qualifying Round<br><span>Rules</span><br>')
    .addScene((done) => {
   ...
   .addScene(' 1) All the teams will play this round on computers.<br>')
    .addScene(' 2) There are a total of 30 multiple choice questions based on <i>Computer Fundamentals</i> and <i>Basics of Computer Networking & Mobile Communication.</i> <br> ')
.addScene('  3) For every correct answer, the team gets 2 points.<br>')
.addScene(' 4) There will be no negative marking.<br>')
.addScene(' 5) Time limit - 6 minutes.<br>')
    .addScene((done) => {
        setTimeout(() => {
