...
scene
    ...
    .addScene('arden:Rapid Fire Round<br><span>Rules</span><br>')
    .addScene((done) => {
    ...
    .addScene(' 1) You can attempt as many questions as possible in a time limit of 3 Minutes.<br>')
    .addScene('   2) Each question carries 2 marks.<br>')
.addScene('    3) There is no negative marking.<br>   ')
